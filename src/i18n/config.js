...
const resources = {
  en: {
    translation: {
      ...
      missionText:
        "To provide healthy, nutritious meals that help you achieve your fitness goals.",
      missionDesc:
      ...
      ourStory: "Our Story",
      storyText:
        "EAT CLEAN started with a simple belief: healthy eating should be convenient and delicious.",
  ...
  vi: {
    translation: {
      ...
      heroSlides: [
        ...
        { title: "Ngon miệng và bổ dưỡng" },
        { title: "Lên kế hoạch bữa ăn thật dễ dàng" },
      ],
      heroSubtitles: [
        { Subtitle: "Bữa ăn dinh dưỡng giao tận nơi" },
        { Subtitle: "Salad tươi và các món ăn bổ dưỡng được giao tận nhà." },
        {
          Subtitle:
            "Kế hoạch dinh dưỡng được thiết kế riêng phù hợp với lối sống của bạn",
        },
      ],
      ...
      premiumQuality:
        "Bữa ăn chất lượng cao cấp được thiết kế bởi chuyên gia dinh dưỡng",
      ...
      ourMission: "Sứ Mệnh",
      missionText:
        "Cung cấp bữa ăn lành mạnh, giàu dinh dưỡng giúp bạn đạt được mục tiêu sức khỏe.",
      missionDesc:
        "Chúng tôi tin rằng việc ăn uống lành mạnh phải tiện lợi, giá cả phải chăng và ngon miệng. Đó là lý do chúng tôi tạo ra những bữa ăn vừa nuôi dưỡng cơ thể vừa thỏa mãn vị giác của bạn.",
      ourStory: "Câu Chuyện",
      storyText:
        "EAT CLEAN bắt đầu với niềm tin: ăn uống lành mạnh phải tiện lợi và ngon miệng.",
      aboutSubtitle: "Tìm hiểu thêm về sứ mệnh và giá trị của chúng tôi",
      storyDesc:
        "Được thành lập vào năm 2024, EAT CLEAN đã phát triển từ một ý tưởng nhỏ thành nguồn cung cấp bữa ăn dinh dưỡng đáng tin cậy cho hàng ngàn khách hàng. Cam kết của chúng tôi về chất lượng, sự tươi mới và bền vững vẫn không thay đổi.",
      ourValues: "Giá Trị Cốt Lõi",
      valQualityTitle: "Chất Lượng",
      valQualityDesc:
        "Chúng tôi chỉ sử dụng những nguyên liệu tươi ngon và chất lượng nhất",
      valHealthTitle: "Sức Khỏe",
      valHealthDesc:
        "Mỗi bữa ăn đều được thiết kế bởi các chuyên gia dinh dưỡng",
